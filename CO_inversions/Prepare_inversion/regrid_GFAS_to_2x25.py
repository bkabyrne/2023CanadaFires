...
def regrid_GFAS(lat_grid_size,lon_grid_size,lon_2x25,lat_2x25,area_2x25,lon,lat,area_GFAS,CO_Flux_kgCkm2s):
    ...
    inputs                                            
     ...
     - area_GFAS: area at native resolution           
     - CO_Flux_kgCkm2s: CO fire emissions [kgC km-2 s-1]
    '''
...
if __name__ == "__main__":
    ...
    area_GFAS = calculate_area(lat,lon,lat_grid_size,lon_grid_size)
    ...
    # Regrid data
    CO_regrided = regrid_GFAS(lat_grid_size,lon_grid_size,lon_2x25,lat_2x25,area_2x25,lon,lat,area_GFAS,CO_Flux_kgCkm2s)
    # write data
