...
dest_dir="/nobackup/bbyrne1/GHGF-CMS-7day-COinv-MonteCarlo"
...
for model in "QFED" "GFAS"; do
	...
	# Pad the ens_member with leading zeros if necessary
        ...
        source_file="SF_perturb_${model}_2023_${ens_member_padded}_7day.nc"
...
for model in "GFED"; do
	...
	# Pad the ens_member with leading zeros if necessary
        ...
        model_dest_dir="${dest_dir}/Run_COinv_${ens_member_padded}"
	dest_file_old="SF_perturb_${ens_member_padded}.nc"
	dest_file="SF_perturb.nc"
