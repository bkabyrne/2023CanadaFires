    ...
    for rep in [0,1]:
        for year in range(2023,2024):
            for prior_model in ['GFED','GFAS','QFED']:
                ...
                if rep==1:
                    ncfile_SF = '/nobackup/bbyrne1/GHGF-CMS-7day-COinv-'+str(year).zfill(4)+'/Run'+OH_choice+'_COinv_rep_'+prior_model+'_'+str(year).zfill(4)+'/GDT-EMS/EMS-sf-'+iteration+'.nc'
                else:
                ...
                if rep==1:
                    ncfile_out = dir_out+'TROPOMI'+OH_choice+'_rep_'+prior_model+'_COinv_2x25_'+str(year).zfill(4)+'_fire_7day.nc'
                else:
                    ncfile_out = dir_out+'TROPOMI'+OH_choice+'_'+prior_model+'_COinv_2x25_'+str(year).zfill(4)+'_fire_7day.nc'
