...
nc_out = './data_for_figures/precip_MaySep_MERRA2_regrid.nc'
f = Dataset(nc_out,'r')
area = f.variables['area'][:] # mm
f.close()

yyyy = 2012
nc_out = './data_for_figures/CANADA_GFED_MOPITT_COinv_2x25_'+str(yyyy).zfill(4)+'_oneFlux.nc'
f = Dataset(nc_out,'r')
latitude = f.variables['latitude'][:]
longitude = f.variables['longitude'][:]
prior = f.variables['prior'][:] # gC/m2/day
post = f.variables['post'][:] # gC/m2/day
f.close()
