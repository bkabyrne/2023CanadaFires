...
'''
 ...
 This code processes data and plots Figures 1, S1 and S2   
...
def plot_box_whiskers(x,array,colorN,alphaN,hatch_flag):
    ...
    #  inputs:
    #    x: integer
    #    array: data to calculate box-and-whisker plot from
    #    colorN: color of plot
...
def plot_section(GFED,GFAS,QFED,start,ispost):
    #
    # =======================
    # Plots three bars of GFED-, GFAS-, and QFED-based
    # inversion results for a given experimental set-up
    #
    #  inputs:
    #    GFED: fire emissions w/ GFED prior
    #    GFAS: fire emissions w/ GFAS prior
    #    QFED: fire emissions w/ QFED prior
    #    start: x-value for start of section
    #    ispost: boolean, is it posterior flux (1) or prior (0)
    # =======================
    #
    if ispost==0:
