...
f.close()
# -------------
f = Dataset('Canada_managed_mask_2x25.nc','r')
managed = f.variables['managed'][:]
unmanaged = f.variables['unmanaged'][:]
f.close()
# -------------
f = Dataset('./data_for_figures/TROPOMI_GFED_COinv_2x25_2023_fire_3day.nc','r')
...
flux_total = [np.sum(COandCO2_post_GFED_3day * area),
              np.sum(COandCO2_post_GFAS_3day * area),
              np.sum(COandCO2_post_QFED_3day * area),
              np.sum(COandCO2_post_GFED_3day_rep * area),
              np.sum(COandCO2_post_GFAS_3day_rep * area),
              np.sum(COandCO2_post_QFED_3day_rep * area),
              np.sum(COandCO2_post_GFED_7day * area),
              np.sum(COandCO2_post_GFAS_7day * area),
              np.sum(COandCO2_post_QFED_7day * area),
              np.sum(COandCO2_post_GFED_7day_rep * area),
              np.sum(COandCO2_post_GFAS_7day_rep * area),
              np.sum(COandCO2_post_QFED_7day_rep * area)]

flux_managed = [np.sum(COandCO2_post_GFED_3day * managed * area),
                np.sum(COandCO2_post_GFAS_3day * managed * area),
                np.sum(COandCO2_post_QFED_3day * managed * area),
                np.sum(COandCO2_post_GFED_3day_rep * managed * area),
                np.sum(COandCO2_post_GFAS_3day_rep * managed * area),
                np.sum(COandCO2_post_QFED_3day_rep * managed * area),
                np.sum(COandCO2_post_GFED_7day * managed * area),
                np.sum(COandCO2_post_GFAS_7day * managed * area),
                np.sum(COandCO2_post_QFED_7day * managed * area),
                np.sum(COandCO2_post_GFED_7day_rep * managed * area),
                np.sum(COandCO2_post_GFAS_7day_rep * managed * area),
                np.sum(COandCO2_post_QFED_7day_rep * managed * area)]

flux_unmanaged = [np.sum(COandCO2_post_GFED_3day * unmanaged * area),
                np.sum(COandCO2_post_GFAS_3day * unmanaged * area),
                np.sum(COandCO2_post_QFED_3day * unmanaged * area),
                np.sum(COandCO2_post_GFED_3day_rep * unmanaged * area),
                np.sum(COandCO2_post_GFAS_3day_rep * unmanaged * area),
                np.sum(COandCO2_post_QFED_3day_rep * unmanaged * area),
                np.sum(COandCO2_post_GFED_7day * unmanaged * area),
                np.sum(COandCO2_post_GFAS_7day * unmanaged * area),
                np.sum(COandCO2_post_QFED_7day * unmanaged * area),
                np.sum(COandCO2_post_GFED_7day_rep * unmanaged * area),
                np.sum(COandCO2_post_GFAS_7day_rep * unmanaged * area),
                np.sum(COandCO2_post_QFED_7day_rep * unmanaged * area)]

print('total')
print(np.max(flux_total) * 1e-12)
print(np.mean(flux_total) * 1e-12)
print(np.min(flux_total) * 1e-12)

print('managed')
print(np.max(flux_managed) * 1e-12)
print(np.mean(flux_managed) * 1e-12)
print(np.min(flux_managed) * 1e-12)

print('unmanaged')
print(np.max(flux_unmanaged) * 1e-12)
print(np.mean(flux_unmanaged) * 1e-12)
print(np.min(flux_unmanaged) * 1e-12)
